...
export default function aboutus() {
  ...
  const inputStyles =
    " inputStyles w-full  mx-auto p-2 outline-none bg-transparent  text-black  font-xl  border-slate-700 ";
  return (
    <>
        ...
        <div className=" flex flex-col w-3/4 mx-auto rounded-lg p-4 items-center content-center bg-slate-300">
          ...
          <form action="" className=" signupForm w-11/12  mx-auto flex flex-col">
            ...
            />
            <button className="px-2 py-1 rounded-md text-black font-bold mt-2 w-1/3  mx-auto border-black" type="submit">Send</button>
          </form>
        </div>
      </div>
      <Footer />
